...
function genFunctionContent_LL(wxmlName, config = {}, source, funcName, x, isCut) {
    ...
    // path
    content += `\u000aif(path&&e_[path]){\u000a${!isCut?"outerGlobal.__wxml_comp_version__=0.02\u000a":""}return function(env,dd,global){$gwxc=0;var root={\u0022tag\u0022:\u0022wx-page\u0022};root.children=[]\u000a;g=\u0022${config.funcName}\u0022;var main=e_[path].f\u000acs=[]\u000aif (typeof global===\u0022undefined\u0022)global={};global.f=$gdc(f_[path],\u0022\u0022,1);\u000a${!isCut?"if(typeof(outerGlobal.__webview_engine_version__)!='undefined'&&outerGlobal.__webview_engine_version__+1e-6>=0.02+1e-6&&outerGlobal.__mergeData__)\u000a{\u000aenv=outerGlobal.__mergeData__(env,dd);\u000a}\u000a":""}try{\u000amain(env,{},root,global);\u000a_tsd(root)\u000a${!isCut?"if(typeof(outerGlobal.__webview_engine_version__)=='undefined'|| outerGlobal.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}\u000a":""}}catch(err){\u000aconsole.log(cs, env);\u000aconsole.log(err)\u000athrow err\u000a}\u000a;g=\u0022\u0022;\u000areturn root;\u000a}\u000a}\u000a}\u000a}`;
    // end
...
function genCommonContent_LL(source, funcName, pageConfig, x, isCut) {
    let common =
    ...
    common += !isCut ? "__globalThis.__wcc_version__='v0.5vv_20200413_syb_scopedata';__globalThis.__wcc_version_info__={\u0022customComponents\u0022:true,\u0022fixZeroRpx\u0022:true,\u0022propValueDeepCopy\u0022:false};\u000avar $gwxc\u000avar $gaic={}\u000avar outerGlobal=typeof __globalThis==='undefined'?window:__globalThis;": "global.__wcc_version__='v0.5vv_20200413_syb_scopedata';global.__wcc_version_info__={\"customComponents\":true,\"fixZeroRpx\":true,\"propValueDeepCopy\":false};\nvar $gwxc\nvar $gaic={}\n"
    common += "var cs = cs || [];\n" +
        funcName +
        "=function(_,_v,_n,_p,_s,_wp,_wl,$gwn,$gwl,$gwh,wh,$gstack,$gwrt,gra,grb,TestTest,wfor,_ca,_da,_r,_rz,_o,_oz,_1,_1z,_2,_2z,_m,_mz,nv_getDate,nv_getRegExp,nv_console,nv_parseInt,nv_parseFloat,nv_isNaN,nv_isFinite,nv_decodeURI,nv_decodeURIComponent,nv_encodeURI,nv_encodeURIComponent,$gdc,nv_JSON,_af,_gv,_ai,_grp,_gd,_gapi,$ixc,_ic,_w,_ev,_tsd){return function(path,global){\u000aif(typeof global==='undefined'){if (typeof __GWX_GLOBAL__==='undefined')global={};else global=__GWX_GLOBAL__;}if(typeof __WXML_GLOBAL__ === 'undefined') {__WXML_GLOBAL__={};\u000a}__WXML_GLOBAL__.modules = __WXML_GLOBAL__.modules || {};\u000a";
...
function wxmlToJS(options = {}) {
    ...
    if (wcc.status === 0) {
        ...
        DEBUG_OUTPUT &&
            fs.writeFileSync(`${process.env.WX_DEBUG_COMPILER_OUTPUT}/linux_output.js`, result);
