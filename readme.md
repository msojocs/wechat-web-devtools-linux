...
[![wechat-tools](https://img.shields.io/badge/wechat--devtools-1.06.2206090-yellow)](https://developers.weixin.qq.com/miniprogram/dev/devtools/download.html)
...
当前工具可以在Linux上构筑最新版 `1.06.2206090`，支持CLI模式。
