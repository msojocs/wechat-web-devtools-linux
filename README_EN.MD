...
`bin/wechatide` is the Linux command-line entry point for WeChat DevTools skills and MCP. See the official [DevTools Skills documentation](https://developers.weixin.qq.com/miniprogram/dev/devtools/Skills.html) for usage.
